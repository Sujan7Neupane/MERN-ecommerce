...
import { createSlice } from "@reduxjs/toolkit";
const cartFromStorage = localStorage.getItem("cartData")
  ? JSON.parse(localStorage.getItem("cartData"))
  : {};

const initialState = {
  cartItems: cartFromStorage, // { productId: { size: quantity } }
};
...
export const { addToCart, updateQuantity, removeItemCompletely, clearCart } =
  cartSlice.actions;
export default cartSlice.reducer;
